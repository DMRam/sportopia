...
import 'organizer_profile_model.dart';
export 'organizer_profile_model.dart';

class OrganizerProfileWidget extends StatefulWidget {
  const OrganizerProfileWidget({super.key});

  @override
  _OrganizerProfileWidgetState createState() => _OrganizerProfileWidgetState();
}

class _OrganizerProfileWidgetState extends State<OrganizerProfileWidget> {
  late OrganizerProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrganizerProfileModel());
