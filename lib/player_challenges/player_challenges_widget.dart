...
import 'player_challenges_model.dart';
export 'player_challenges_model.dart';

class PlayerChallengesWidget extends StatefulWidget {
  const PlayerChallengesWidget({super.key});

  @override
  _PlayerChallengesWidgetState createState() => _PlayerChallengesWidgetState();
}

class _PlayerChallengesWidgetState extends State<PlayerChallengesWidget> {
  late PlayerChallengesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlayerChallengesModel());
