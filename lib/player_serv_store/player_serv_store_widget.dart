...
import 'player_serv_store_model.dart';
export 'player_serv_store_model.dart';

class PlayerServStoreWidget extends StatefulWidget {
  const PlayerServStoreWidget({super.key});

  @override
  _PlayerServStoreWidgetState createState() => _PlayerServStoreWidgetState();
}

class _PlayerServStoreWidgetState extends State<PlayerServStoreWidget>
    with TickerProviderStateMixin {
  late PlayerServStoreModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlayerServStoreModel());
