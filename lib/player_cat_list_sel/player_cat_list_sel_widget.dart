...
import 'player_cat_list_sel_model.dart';
export 'player_cat_list_sel_model.dart';

class PlayerCatListSelWidget extends StatefulWidget {
  const PlayerCatListSelWidget({super.key});

  @override
  _PlayerCatListSelWidgetState createState() => _PlayerCatListSelWidgetState();
}

class _PlayerCatListSelWidgetState extends State<PlayerCatListSelWidget> {
  late PlayerCatListSelModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlayerCatListSelModel());
