...
import 'player_store_model.dart';
export 'player_store_model.dart';

class PlayerStoreWidget extends StatefulWidget {
  const PlayerStoreWidget({super.key});

  @override
  _PlayerStoreWidgetState createState() => _PlayerStoreWidgetState();
}

class _PlayerStoreWidgetState extends State<PlayerStoreWidget>
    with TickerProviderStateMixin {
  late PlayerStoreModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlayerStoreModel());
