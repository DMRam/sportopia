...
import 'player_game_model.dart';
export 'player_game_model.dart';

class PlayerGameWidget extends StatefulWidget {
  const PlayerGameWidget({super.key});

  @override
  _PlayerGameWidgetState createState() => _PlayerGameWidgetState();
}

class _PlayerGameWidgetState extends State<PlayerGameWidget>
    with TickerProviderStateMixin {
  late PlayerGameModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlayerGameModel());
